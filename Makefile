...
List_public_test.exe: List_public_test.cpp unit_test_framework.cpp List.h
	$(CXX) $(CXXFLAGS) $< unit_test_framework.cpp -o $@

Stack_public_test.exe: Stack_public_test.cpp unit_test_framework.cpp List.h Stack.h
	$(CXX) $(CXXFLAGS) $< unit_test_framework.cpp -o $@
